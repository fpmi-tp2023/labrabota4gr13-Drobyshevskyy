...
void create_insert_query(char *query) {
    ...
    input_str_field(query, str_buffer, PATRONYMIC);
    input_str_field(query, str_buffer, HOME_ADDRESS);
    input_str_field(query, str_buffer, NATIONALITY);
    input_int_field(query, BIRTHDAY);
    input_str_field(query, str_buffer, POST);
    input_str_field(query, str_buffer, RANK);
